...
import qboot_Boottenant from 'boot/tenant'

import qboot_Bootauth from 'boot/auth'

import qboot_Bootflags from 'boot/flags'
...
async function start () {
  ...
  const bootFiles = [qboot_Booti18n,qboot_Bootapollo,qboot_Boottenant,qboot_Bootauth,qboot_Bootflags]
